...
if __name__ == '__main__':
    ...
    if not cfg.MODEL.DIST_TRAIN or args.local_rank==0:
        logger.info("Running with config:\n{}".format(cfg))

    if cfg.MODEL.DIST_TRAIN and not torch.distributed.is_initialized():
        torch.distributed.init_process_group(backend='nccl', init_method='env://')

    train_loader, train_loader_normal, val_loaders, num_querys, num_classes, camera_num, view_num = make_dataloader(cfg)
