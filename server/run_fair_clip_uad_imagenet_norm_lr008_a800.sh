...
echo "RUN=C5_fair_clip_uad_imagenet_norm_lr008 CONFIG=configs/fair_clip_uad_imagenet_norm_lr008.yml LOSS_TYPE=base+pca+gpd NORM=imagenet BACKBONE_LR=0.008 DROP_PATH=0.1 SEED=1234"
CUDA_VISIBLE_DEVICES=0 WORLD_SIZE=1 /mnt/cache/wanghanzhi/envs/whu_mars/bin/python3 train.py \
  --config_file configs/fair_clip_uad_imagenet_norm_lr008.yml \
  ...
  TEST.FEAT_NORM yes \
  TEST.TOP_K_EVAL 0 \
  OUTPUT_DIR /mnt/cache/wanghanzhi/XK/CVPR26_UAD/outputs/fair_baseline_v2/clip/C5_uad_imagenet_norm_lr008_seed1234
