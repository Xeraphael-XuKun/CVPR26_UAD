...
echo "RUN=C_clip_uad CONFIG=configs/clip_uad.yml LOSS_TYPE=base+pca+gpd NORM=0.5 BACKBONE_LR=0.0008 BACKBONE_BIAS_LR=0.0016 HEAD_LR=0.008"
CUDA_VISIBLE_DEVICES=0 WORLD_SIZE=1 /mnt/cache/wanghanzhi/envs/whu_mars/bin/python3 train.py \
  ...
  TEST.FEAT_NORM yes \
  TEST.TOP_K_EVAL 0 \
  OUTPUT_DIR /mnt/cache/wanghanzhi/XK/CVPR26_UAD/outputs/clip_vit_b16/C_clip_uad_seed1234
