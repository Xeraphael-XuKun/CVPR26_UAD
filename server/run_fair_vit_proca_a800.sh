...
echo "RUN=V2_fair_vit_proca CONFIG=configs/fair_vit_proca.yml LOSS_TYPE=base+pca NORM=0.5 BACKBONE_LR=0.008 DROP_PATH=0.1 SEED=1234"
CUDA_VISIBLE_DEVICES=0 WORLD_SIZE=1 /mnt/cache/wanghanzhi/envs/whu_mars/bin/python3 train.py \
  --config_file configs/fair_vit_proca.yml \
  ...
  TEST.FEAT_NORM yes \
  TEST.TOP_K_EVAL 0 \
  OUTPUT_DIR /mnt/cache/wanghanzhi/XK/CVPR26_UAD/outputs/fair_baseline_v2/vit/V2_proca_seed1234
